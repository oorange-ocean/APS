<template>
    <div class="container">
        ...
        <div class="right">
            <el-tag :key="tag.name" v-for="(tag, index) in tags" :closable=true :disable-transitions="false"
                :class="changeColor(tag)" @click="changeMenu(tag)" @close="handleClose(tag, index)"
