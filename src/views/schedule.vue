<template>
    <keep-alive>
        <div class="card" v-loading="Scheduling.loading" element-loading-text="正在运行中，可能需要十五秒左右，请耐心等待···">
                    ...
                    <div v-if="!isCollapsed">
                        <el-collapse>
                            <el-collapse-item title="ERP" name="1">
                                <el-checkbox :indeterminate="indeterminateERP" v-model="isAllERP"
                                    @change="handleCheckAllERP">全选</el-checkbox>
                                <el-checkbox-group v-model="checkedERP" @change="handleCheckedERP" class="group">
                            ...
                            <el-collapse-item title="MES" name="2">
                                <el-checkbox :indeterminate="indeterminateMES" v-model="isAllMES"
                                    @change="handleCheckAllMES">全选</el-checkbox>
                                <el-checkbox-group v-model="checkedMES" @change="handleCheckedMES" class="group">
