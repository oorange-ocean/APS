  ...
  <div class="container">
    <div class="main">
      ...
      >
        ...
        <el-table-column prop="ftotalQuantity" label="总数量" width="70">
          <template v-slot:default="scope">
            {{ formatNumber(scope.row.ftotalQuantity) }}
          </template>
        </el-table-column>
        <el-table-column prop="fcompletedQuantity" label="完成数量" width="150">
        </el-table-column>
        <el-table-column
...
function handleSizeChange(newSize) {
  ...
  production
    .getProductionPlan(currentPage.value, currentSize.value)
    .then((res) => {
      if (res.code == 201) {
...
function handlePages(page) {
  ...
  production
    .getProductionPlan(page, currentSize.value)
    .then((res) => {
      if (res.code == 201) {
        ElMessageBox.alert(res.message, '提示', {
          confirmButtonText: '好的'
