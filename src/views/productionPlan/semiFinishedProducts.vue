    ...
    <div class="container">
        ...
        <div class="main" ref="tableContainer">
            <div class="common" ref="commonPlan">
                <common-plan class="plan" :columnNames="production.semiFinishedProducts.column"
                    :viewColumn="production.semiFinishedProducts.viewColumn" :currentViewId="currentViewId"
                    :currentViewName="currentViewName" :apiUrl="'/scResult/searchLike'" :currentOrder="currentOrder"
                    @lookView="lookView" @searchView="searchView" :currentTableId="42"
                    @getCurrentOption="getCurrentOption" />
            </div>

            <el-table ref="myTable" :data="production.semiFinishedProducts.data" border
                ...
                <el-table-column prop="fmaterialCode" label="物料编码" width="200" sortable="custom"
                    :sort-orders="['ascending', 'descending']" v-if="plan.fmaterialCode">
                ...
                <el-table-column prop="fmaterialName" label="物料名称" width="300" sortable="custom"
                    :sort-orders="['ascending', 'descending']" v-if="plan.fmaterialName">
                    <template v-slot:header="{ column }">
                        <div>
                            {{ column.label }}
                            <span v-html="renderSortIcon(column)"></span>
                ...
                <el-table-column prop="fquantity" label="数量" width="100" v-if="plan.fquantity" sortable="custom"
                ...
                <el-table-column prop="fstartTime" label="开始制作时间" width="200" sortable="custom"
                    :sort-orders="['ascending', 'descending']" v-if="plan.fstartTime">
                    <template v-slot:header="{ column }">
                        <div>
                            {{ column.label }}
                            <span v-html="renderSortIcon(column)"></span>
                ...
                <el-table-column prop="frequiredDeliveryTime" label="需入库时间" width="200" sortable="custom"
                    :sort-orders="['ascending', 'descending']" v-if="plan.frequiredDeliveryTime">
                    <template v-slot:header="{ column }">
                        <div>
                            {{ column.label }}
                            <span v-html="renderSortIcon(column)"></span>
            ...
            <div class="bottom" :style="{
                ...
                <Pagination :total="production.semiFinishedProducts.pages" @change-page="handlePages"
                    @update-size="handleSizeChange" :totalRows="production.semiFinishedProducts.total"
