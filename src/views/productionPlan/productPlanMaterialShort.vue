  ...
  <div class="container productSM">
    ...
    <div class="main" ref="tableContainer">
      <div class="common" ref="commonPlan">
        <common-plan
          class="plan"
          :columnNames="production.productPlanMaterialShort.column"
      ...
      <el-table
        ref="myTable"
        :data="production.productPlanMaterialShort.data"
        border
        ...
        :default-sort="{ prop: 'ftaskId', order: 'ascending' }"
      >
        <el-table-column
          prop="ftaskId"
          label="任务号"
        ...
        <el-table-column
          ...
          sortable="custom"
          :sort-orders="['ascending', 'descending']"
          v-if="plan.fsubMaterialQuantity"
        >
          <template v-slot:header="{ column }">
            <div>
              {{ column.label }}
        ...
        <el-table-column
          ...
          sortable="custom"
          :sort-orders="['ascending', 'descending']"
          v-if="plan.fsubMaterialDeliveryTime"
        >
        <template v-slot:header="{ column }">
            <div>
              {{ column.label }}
