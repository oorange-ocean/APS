    ...
    <div class="container">
        ...
        <div class="main" ref="tableContainer">
            <div class="common" ref="commonPlan">
                <common-plan class="plan" :columnNames="process.processNames.column"
                    :viewColumn="process.processNames.viewColumn" :currentViewId="currentViewId"
                    :currentViewName="currentViewName" :apiUrl="'/masterData/searchLike'" :currentTableId="60"
                    :currentOrder="currentOrder" @lookView="lookView" @searchView="searchView"
                    @getCurrentOption="getCurrentOption" />
            </div>
            <el-table ref="myTable" :data="process.processNames.data" :row-class-name="tableRowClassName" border
                ...
                <el-table-column prop="number" label="序号" width="100" sortable="custom"
                    :sort-orders="['ascending', 'descending']" v-if="true">
                </el-table-column>
                <el-table-column prop="processName" label="工序名称" sortable="custom" width="300"
                    :sort-orders="['ascending', 'descending']" v-if="plan.processName">
            ...
            <div class="bottom" :style="{
                ...
                <Pagination :total="process.processNames.pages" @change-page="handlePages"
                    @update-size="handleSizeChange" :totalRows="process.processNames.total"
