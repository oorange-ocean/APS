<template>
    ...
    <div class="container">
      ...
      <div class="main" ref="tableContainer">
        <el-table
          :data="ImmediateInventory.tfminisSnLabeling.data"
          border
        ...
        >
          ...
          <el-table-column prop="unBurnQualifiedCount" label="安装不合格数" width="90">
            <template #default="{ row }">
              <template v-if="row.editable">
      ...
      <div class="bottom">
        <Pagination
          :total="ImmediateInventory.tfminisSnLabeling.pages"
          @change-page="handlePages"
          @update-size="handleSizeChange"
          :totalRows="ImmediateInventory.tfminisSnLabeling.total"
        />
      </div>
    </div>
  </template>
  ...
  function handleSizeChange(newSize) {
    ...
    ImmediateInventory.getAllPage(currentPage.value, currentSize.value, 27)
      .then((res) => {
  ...
  function addRow() {
    ...
    if (scrollContainer) {
      ...
      ImmediateInventory.tfminisSnLabeling.data.unshift({ ...newRow });
      addAble = false;
    } else {
      return;
    }
  ...
  function handlePages(page) {
    ...
    ImmediateInventory.getAllPage(page, currentSize.value, 27)
      .then((res) => {
        const scrollContainer = tableContainer.value.querySelector(
      '.el-scrollbar__wrap'
    )
