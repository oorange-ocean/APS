    ...
    <div class="container">
        ...
        <div class="main" ref="tableContainer">
            <div class="common" ref="commonPlan">
                <common-plan class="plan" :columnNames="ImmediateInventory.receiveNotice.column"
                    :viewColumn="ImmediateInventory.receiveNotice.viewColumn" :currentViewId="currentViewId"
            ...
            <el-table ref="myTable" :data="ImmediateInventory.receiveNotice.data" border
            ...
            <div class="bottom" :style="{
                ...
                <Pagination :total="ImmediateInventory.receiveNotice.pages" @change-page="handlePages"
                    @update-size="handleSizeChange" :totalRows="ImmediateInventory.receiveNotice.total"
...
import { columnConfig } from '@/columnConfig/ERP/receiveNotice'
...
const dynamicColumns = computed(() => {
    if (currentViewId.value === '-1') {
        ...
        return columnConfig
    } else if (!ImmediateInventory.receiveNotice.viewColumn) {
        return []
    }

    return ImmediateInventory.receiveNotice.viewColumn
        .map(viewCol => {
...
function lookView(viewId, viewName) {
    ...
    ImmediateInventory.getPageFiltrate(
        ...
        .then((res) => {
            ...
            if (viewId == '-1') {
                // 当 viewId 为 -1 时，使用所有列
                ImmediateInventory.receiveNotice.viewColumn = columnConfig.map(col => ({
                    voColName: col.prop,
