  ...
  <div class="container">
    ...
    <div class="main" ref="tableContainer">
      <div class="common" ref="commonPlan">
        <common-plan
          class="plan"
          :columnNames="ImmediateInventory.purchaseOrder.column"
      ...
      >
        ...
        >
          ...
          <template #default="{ row }">
            <template v-if="row.editable">
              <el-input v-model="row.baseUnitQty" @keyup.enter="saveRow(row)" />
            </template>
            <template v-else>
              {{ formatNumber(row.baseUnitQty) }}
            </template>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          ...
          <template #default="{ row }">
            <template v-if="row.editable">
              <el-input v-model="row.arrivalDate" @keyup.enter="saveRow(row)" />
            </template>
            <template v-else>
              {{ row.arrivalDate }}
            </template>
